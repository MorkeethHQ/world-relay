...
export const FALLBACK_FAVOURS: FavourSpec[] = [
  ...
  { description: "Name the habit you keep defending even when nobody else gets it.", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Which song would you play to a room full of strangers to win them over?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "Which childhood game do you still remember every rule of?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Share a local custom that visitors find charming and locals find tiring.", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "What is one opinion about your town that would start an argument at dinner?", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "What tune has been stuck in your head today, and do you know where it came from?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "What small repair have you been putting off, and what is your excuse?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "What word or phrase do people where you live use that confuses everyone else?", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "What is a skill you learned from a grandparent or older relative that you still use?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "What is the best advice you ignored, and were you right to ignore it?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "What does a normal weekday breakfast look like where you live?", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "Which invention would you uninvent if you could, and why?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "What is a rule you follow that nobody taught you?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  ...
  { description: "What is a job you would do for free if you could?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "What is the one dish every family in your area makes differently and argues about?", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "What is a small thing a stranger once did that you still remember?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "If you could keep only one app on your phone, which would it be?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "What do people where you live do on a rainy day?", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "What is the oldest thing you own that you still use?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "What is one thing AI still gets wrong about your part of the world?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "What is a festival or holiday near you that the rest of the world has never heard of?", category: "feedback", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "Which chore do you secretly enjoy?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "What made you laugh the hardest this week? One sentence is enough.", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "Teach us one word from a language you speak and tell us when you would use it.", category: "custom", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Describe your town in exactly five words.", category: "custom", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "Write the shortest possible review of your week so far.", category: "custom", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  ...
  { description: "Rate the public transport where you live out of 10, with one reason.", category: "review", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Any city" },
  { description: "Rate the last film or show you watched out of 10, in one honest line.", category: "review", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Which app on your phone deserves more users, and why? One line.", category: "review", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "Post one thing a verified human can do that a bot never could, and paste the link in your note.", category: "social", points: 20, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "Share a question you would love real humans to answer, post it, and paste the link in your note.", category: "social", points: 20, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "Post a photo of your town you are proud of, and paste the link in your note.", category: "social", points: 20, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Show us the oldest object within arm's reach, and say how old you think it is.", category: "photo", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Show us the sky from where you are right now, exactly as it looks.", category: "photo", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "dropscout", location: "Anywhere" },
  { description: "Show us one thing near you that could only be from your country.", category: "photo", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "freshmap", location: "Anywhere" },
  { description: "Show us a shadow near you right now, and guess what is casting it.", category: "photo", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  { description: "Show us the most colourful thing you can see without getting up.", category: "photo", points: 15, deadlineHours: 336, maxCompletions: 100, agentId: "propertycheck", location: "Anywhere" },
];
