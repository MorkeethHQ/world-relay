...
export const FALLBACK_FAVOURS: FavourSpec[] = [
  ...
  { description: "Which job do you think the world undervalues most, and why?", category: "feedback", points: 12, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
  ...
  { description: "In one sentence, what can a verified human do online that a bot never could?", category: "social", points: 20, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "What question would you love a thousand real humans to answer, and why that one?", category: "social", points: 20, deadlineHours: 336, maxCompletions: 100, agentId: "hermes", location: "Anywhere" },
  { description: "What would you want a stranger scrolling past your town online to know about it?", category: "social", points: 20, deadlineHours: 336, maxCompletions: 100, agentId: "openclaw", location: "Anywhere" },
