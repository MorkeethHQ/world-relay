...
export const CAMPAIGNS: Campaign[] = [
  {
    ...
    name: "Welcome Back",
    brand: "FAVOUR",
    tagline: "Four small favours. Points for each — and $2 USDC for one clean one.",
    description:
      "FAVOUR went quiet for a while. It's back, and the pot is funded. Four small favours — nothing that takes more than five minutes, nothing you need to leave your day for. Every clean, AI-verified proof earns points. ONE clean favour — any of the four — as an Orb-verified human unlocks $2 USDC straight to your wallet. The pot covers 20 humans and when it's gone it's gone. Tell us what to build next while you're here — that one's points, and we actually read them.",
    // Ink, not teal: a points campaign never wears money colours (DESIGN-SYSTEM).
  ...
  },
  {
    ...
    heroGradient: "from-amber-900 via-orange-800 to-amber-800",
